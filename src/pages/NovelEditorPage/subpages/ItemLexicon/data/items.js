    ...
    derivatives: [
      {
        ...
        progress: 0.9,
        image: CORE_IMG,
        desc: '元石粒子被地脉的能量长河冲刷，定型于「共鸣态」构象——粒子只松松相耦，能量在其间如涟漪般传递、叠加、放大。故鸣金能吞纳、储存、导引乃至放大能量，叩之铮然如雷鸣。然共鸣的松散构象注定其质脆易裂、不耐冲击、不能承力；神品鸣金逼近过载，受激极易暴走，须以磐金封存。外来者按粒子强度记作 XA/XB/XC-雷石，本地俗谓雷金、乌鲁。',
        children: [
          {
            name: '蓄能核',
            alias: '储能',
      ...
      },
      {
        ...
        progress: 0.95,
        image: CORE_IMG,
        desc: '与鸣金相反，元石粒子若被岁月定型于「锁合态」——粒子彼此锁死、层层咬合如金刚——便成磐金。坚不可摧而绝对沉默：不传半分能量，故亦绝缘之极，更是唯一能封印鸣金与神品矿能量暴走的容器。乃城防之基、神兵之骨。外来者记作 XA/XB/XC-坚石，本地俗谓精金、玄铁。',
        children: [
          {
            name: '锁甲',
            alias: '装甲',
