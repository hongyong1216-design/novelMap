...
export const initialItems = [
  ...
  },
  {
    ...
    type: '原矿 / 母矿',
    rarity: 'rare',
    desc: '元石是含元粒子矿物的原初母矿——粒子新脱地脉、游离未凝，既未被岁月锁定于「锁合」或「共鸣」任一构象，也未同化定型为某种凡矿，故最富可塑而尤为珍稀。多采自粒子涌泉、古老地脉与上古遗骸深处的核心矿囊，出土时粒子近饱和而躁动，须以磐金匣封存、借光照与地脉活性能量供养，否则离脉即次第坠入沉睡、饥饿而失效。元石须经加工方堪驱用：或由塑形者以意志引导、工匠以工法淬炼，或在特殊地脉中历经万年自行凝固同化——待其构象锁定、元素同化定型，便成堪用的成品「元晶」，循被定的构象与所化的元素分作鸣金、磐金、流光石、赤锉四大矿种。而比矿种、品相更要紧的一条分野，在其中粒子的内核——是空白待书的「纯净」，抑或已封能力的「藏忆」：藏忆元石天生带异能却偏执排他、异能之间难以共核，纯净元石则无成见而兼容一切，乃凝成又强又全之核的唯一底料，故可遇不可求、价值无可估量。',
    image: CORE_IMG,
    derivatives: [
      {
        name: '鸣金',
        ...
        progress: 0.9,
        image: CORE_IMG,
        desc: '元石粒子被地脉的能量长河冲刷，定型于「共鸣态」构象——壳层结点只松松相搭，能量在其间如涟漪般传递、叠加、放大。故鸣金能吞纳、储存、导引乃至放大能量，叩之铮然如雷鸣。然共鸣的松散构象注定其质脆易裂、不耐冲击、不能承力；神品鸣金逼近过载，受激极易暴走，须以磐金封存。外来者按粒子强度记作 XA/XB/XC-雷石，本地俗谓雷金、乌鲁。',
        children: [
          {
            name: '蓄能核',
            alias: '储能',
          ...
          },
          {
            name: '导脉',
            alias: '导能',
            desc: '拉成丝缕的鸣金，能以极低损耗引导能量流转，如血脉贯连器物，是一切粒子造物的「线路」。',
          },
          {
            name: '惊雷',
            alias: '共鸣暴源',
            desc: '刻意推向过载的神品鸣金，一击炸开积蓄的能量涟漪，是「涟鸣」外化于器的毁灭之源，亦是粒子武器的弹心。',
          },
        ],
      },
      {
        ...
        progress: 0.95,
        image: CORE_IMG,
        desc: '与鸣金相反，元石粒子若被岁月定型于「锁合态」——壳层结点彼此插死、层层咬合如金刚桁架——便成磐金。坚不可摧而绝对沉默：不传半分能量，故亦绝缘之极，更是唯一能封印鸣金与神品矿能量暴走的容器。乃城防之基、神兵之骨。外来者记作 XA/XB/XC-坚石，本地俗谓精金、玄铁。',
        children: [
          {
            name: '锁甲',
            alias: '装甲',
          ...
          },
          {
            name: '绝基',
            alias: '绝缘基座',
            desc: '铺设于法阵、器械之下，隔绝杂散能量串扰，令精密的粒子造物免受地脉乱流干扰。',
          },
        ],
      },
      {
        ...
        progress: 0.5,
        image: CORE_IMG,
        desc: '元石粒子在悠长同化中记牢了自身的「完美形态」，便成流光石。它能像活物般愈合磕碰裂痕、循意志重塑外形，更能填补他矿缺损、调和异质矿脉，是最难得的万用之材；活跃时石中五色流转，故名。因需粒子长久同化方成，极为稀有，世人识之未深。外来者记作 XA/XB/XC-愈石，本地敬为五色石、补天石。',
        children: [
          {
            name: '补天',
            alias: '自愈补材',
      ...
      },
      {
        ...
        progress: 0.7,
        image: CORE_IMG,
        desc: '元石粒子同化了理想的金刚晶格记忆，令矿体分子沿最锋锐的方向排布定型，便成赤锉。其色赤如凝血，晶格完美无瑕，锋利绝伦，斩金断玉如切腐木，是利刃与凿具之极品。因偏「形态」而非能量，性稳而少暴走之虞，唯淬炼成锋耗时极长。外来者记作 XA/XB/XC-刃石，本地俗谓昆吾、切玉金。',
        children: [
          {
            name: '切玉',
            alias: '刃锋',
      ...
      },
      {
        ...
        progress: 0.85,
        image: CORE_IMG,
        desc: '元石的价值系于其中元粒子的密度与活性。按含量分三品：凡品粒子稀疏、与凡矿无异；灵品粒子充盈、稳定显矿性；神品近饱和、特性极强近乎有灵，却也逼近过载、受激易暴走。按能量供给又现四态——活跃、沉睡、饥饿、过载：出脉之石多在活跃与过载之间躁动，离脉日久则次第坠入沉睡、饥饿而失效。',
        children: [
          {
            name: '凡品',
            alias: '粒子稀疏',
          ...
          },
          {
            name: '神品',
            alias: '近饱和 · 近有灵',
            desc: '特性极强、粒子近乎有灵，然逼近过载、受激暴走，非磐金匣不能安置。',
          },
        ],
      },
      {
        ...
        progress: 0.4,
        image: CORE_IMG,
        desc: '与「三品」（粒子密度）正交的另一条更要紧的轴，量的是石中粒子的内核是否空白。藏忆之粒早封了能力，各执己见、彼此排斥——尤其两种不同能力的粒子几乎无法共凝一核，纵勉强成核也协调崩坏、样样平平；故藏忆矿纵带现成异能，终归偏执而受限。纯净之粒内核空荡，无成见亦无宿怨，与任何粒子都顺畅咬合，是凝成「又强又全」巨核的唯一底料，亦能调和互斥的异能之粒。然此世意义场无处不在，粒子极易被浸染刻录成藏忆，纯净者唯生于与世隔绝的纯能量深脉，故稀世罕有、得之无价。',
        children: [
          {
            name: '纯净元石',
            alias: '干净 · 空白待书',
          ...
          },
          {
            name: '溯源',
            alias: '纯净何以稀',
            desc: '粒子对「意义」极敏，一经生死、信仰、战乱的意义场浸泡便刻录成藏忆；唯远离一切意义、久浸于纯能量地脉深处者，方能内核长空，终成纯净。',
          },
        ],
      },
      {
        ...
        progress: 0.35,
        image: CORE_IMG,
        desc: '藏忆元石中，粒子封存了「天痕」能力（自然现象千万年自刻于粒子之力）者，便循所封之能命名——含薪火之能者曰火元石，含奔雷之能者曰奔雷石，余者类推。天痕之能按现象尺度分五谱：元素（单一）、天象（复合）、生机（生命）、物相（诸般物理）、天理（罕见近概念），愈往后愈稀。封存又分深浅：多数只留最表层的「现象」记忆，能通「原理」乃至「概念」层者万中无一（见〔能力背景·驭粒〕天痕四层）。然凡藏忆皆偏执——能力元石只认所封那一能，彼此排他、难与异能共核，虽得现成之能终难兼修，恰与纯净元石相对。',
        children: [
          {
            name: '元素元石',
            alias: '六元素 · 最普及',
      ...
      },
      {
        ...
        progress: 0.8,
        image: CORE_IMG,
        desc: '元石采炼自成一门险学。探脉者循地脉活性寻母囊，以赤锉金刚凿破岩取矿；出土的沉睡之石需以光照与活性能量「唤醒」方显本性；而近饱和的神品与躁动的生矿则须即刻纳入磐金封印匣镇住，防其离脉暴走。通晓粒子之性的塑形者，更能于采出后以持续意志引导母矿分化，「种」出所需的鸣金、磐金乃至流光石。',
        children: [
          {
            name: '探脉采掘',
            alias: '寻矿',
        ...
        children: [
          {
            name: '空核待书',
            alias: '内核空荡',
            desc: '无成见、无宿怨，与任何粒子都顺畅咬合，是后天可无限书写的白纸。',
          },
          {
            name: '至稳之性',
            alias: '不因触变',
